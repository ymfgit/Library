...
public class ReaderPwdUpdate extends Composite {
	...
	public ReaderPwdUpdate(Composite parent, int style) {
		super(parent, style);
		setBackgroundImage(SWTResourceManager.getImage(ReaderPwdUpdate.class, "/images/背景1.png"));
		...
		label_6.setBounds(135, 12, 195, 30);
		label_6.setText("读者密码修改");
		...
		label_9.setBounds(27, 146, 393, 31);
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				}else if(newpwd==newpwd1 || newpwd.equals(newpwd1) &&PwdInfoDao.samePWD(text_1)){
					if(pwdInfoDao.updateReaderPwd(text_2)){
